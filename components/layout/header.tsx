    ...
    return (
        <header className='h-20 flex md:justify-end select-none'>
            <section className='shadow-xl flex md:justify-end w-full md:w-fit'>
                <button className='bg-AVZWhi w-1/5 md:w-28 h-full hover:cursor-pointer' title={t('DOWNLOAD')}>
                    <Link href='https://github.com/jiyorude/avantzero/releases' target='_blank' className='mxFlexCenter h-full w-full'>
                        <MdDownload size={45} className='fill-AVZGre bg-transparent size-10' title={t('DOWNLOAD')} />
                    </Link>
                </button>
                <button className='bg-AVZRed w-1/5 md:w-28 h-full hover:cursor-pointer'>
                    <Link href='https://pypi.org/project/avantzero/' target='_blank' className='mxFlexCenter h-full w-full'>
                        <IoLogoPython size={45} className='fill-AVZBla bg-transparent size-10' title={t('PYPIPROJECTPAGE')} />
                    </Link>
                </button>
                <button className='bg-AVZTea w-1/5 md:w-28 h-full hover:cursor-pointer'>
                    <Link href='https://github.com/jiyorude/avantzero/' target='_blank' className='mxFlexCenter h-full w-full'>
                        <IoLogoGithub size={45} className='fill-AVZWhi bg-transparent size-10' title={t('GITHUBREPOSITORY')} />
                    </Link>
                </button>
